"""
Django settings for HelloMusicProject project.
...
SECRET_KEY = 'django-insecure-4084h0*35(8_#eaqm0l6$)lhtan4k6)^!h$spc@=&wnaz@2#aq'
...
WSGI_APPLICATION = 'HelloMusicProject.wsgi.application'
